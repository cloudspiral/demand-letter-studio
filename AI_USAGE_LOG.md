...
| Initial draft | OpenAI Responses / configured `gpt-5.6-sol` | Matter label, confirmed editable template text, replacement/image candidates, extracted page text, source/page IDs | `store: false`, strict JSON Schema, Zod parse, exact source/page quote validation, complete editable-region coverage, conflict and export gates |
...
| Tests | Deterministic mock adapter | Synthetic fixture text | No external model call or API spend |
